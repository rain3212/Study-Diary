...
衰减就好比，我有一把小尺子，但是像测量比自己大好多的物体（就比如5倍吧），然后衰减要做的就是，把这个物体先等比例缩小5倍，然后再用小尺子测量，最终我需要的是一个比例关系，代入公式，可以计算出真正的数值。衰减是在数模转换之前的，衰减越大那么量程越大



<img src="README.assets/image-20260702195847539.png" alt="image-20260702195847539" style="zoom:50%;" />

但是为什么我的代码写成12db会报错呢?

```c++
analogSetPinAttenuation(adcPin, ADC_12db);
```

<img src="README.assets/image-20260702201803311.png" alt="image-20260702201803311" style="zoom:50%;" />
